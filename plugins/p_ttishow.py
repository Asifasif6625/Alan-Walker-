        ...
        for u in message.new_chat_members:
            if (temp.MELCOW).get('welcome') is not None:
                try:
                    ...
                    pass
            if WELCOM_PIC:
                temp.MELCOW['welcome'] = await message.reply_video(video=WELCOM_PIC, caption=WELCOM_TEXT.format(user=u.mention, chat=message.chat.title))
            else:
...
async def get_ststs(bot, message):
    rju = await message.reply('<b>Loading Stats Data....</b>')
